 ...
 * Professional Alpine.js component for vCard generation and sharing
 */
 ...
 * Creates a reusable component that receives contact data via x-data
 */
function createContactComponent(contactData) {
    return {
        ...
        async saveContact() {
            if (!this.contactInfo || !this.contactInfo.name) {
                ...
                const btn = document.getElementById('saveContactBtn');
                if (btn) {
                    btn.innerHTML = '<span class="text-red-500">Error: Sin datos</span>';
                    setTimeout(() => {
...
window.contactComponent = createContactComponent;

// Export for module usage if needed
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { ContactSaver, createContactComponent };
}