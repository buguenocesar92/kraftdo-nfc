            ...
            @foreach($socialLinks as $link)
                @php
                    ...
                    if ($link->platform === 'whatsapp' && !$link->url) {
                        $cleanNumber = preg_replace('/[^0-9]/', '', $link->username);
                        $url = $platform['base_url'] . $cleanNumber;
                    } else {
                    ...
                    $platformColors = [
                        ...
                        'whatsapp' => ['bg' => 'hover:bg-green-50', 'border' => 'hover:border-green-200', 'text' => 'text-green-600', 'focus' => 'focus:ring-green-500']
                    ];
