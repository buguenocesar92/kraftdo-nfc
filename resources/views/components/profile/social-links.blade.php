                        ...
                        @switch($link->platform)
                            @case('instagram')
                                <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.418-3.323c.875-.875 2.026-1.297 3.323-1.297s2.448.422 3.323 1.297c.928.875 1.418 2.026 1.418 3.323s-.49 2.448-1.418 3.244c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.141c-.807 0-1.418-.611-1.418-1.418s.611-1.418 1.418-1.418 1.418.611 1.418 1.418-.611 1.418-1.418 1.418zM12.017 7.09c-3.003 0-5.357 2.354-5.357 5.357s2.354 5.357 5.357 5.357 5.357-2.354 5.357-5.357-2.354-5.357-5.357-5.357z"/>
                                </svg>
                            @break
                            @case('linkedin')
                                <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
