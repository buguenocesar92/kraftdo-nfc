    ...
    public function down(): void
    {
        Schema::table('dynamic_content', function (Blueprint $table) {
            $table->dropColumn([
                ...
                'video_url', 'video_type', 'audio_url', 'audio_type', 'gallery_images',
                'restaurant_name', 'restaurant_phone', 'restaurant_address', 'restaurant_hours', 'menu_items',
                'contact_email', 'contact_phone', 'contact_website', 'social_links', 'skills', 'bio',
                'event_location', 'event_start_date', 'event_end_date', 'event_organizer',
                'product_price', 'product_currency', 'product_sku', 'product_stock',
            ]);
        });
    }
};
